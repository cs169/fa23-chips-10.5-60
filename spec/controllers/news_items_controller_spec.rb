...
describe NewsItemsController, :vcr do
  describe 'GET #index' do
    before do
      ...
      @article1 = NewsItem.create(title: 'Article 1', representative: @rep, link: 'https://google.com/news1')
      @article2 = NewsItem.create(title: 'Article 2', representative: @rep, link: 'https://google.com/news2')
    end
